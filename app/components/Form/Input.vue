  ...
  <div class="w-full relative">
    <div class="flex items-center">
      ...
      <input
        ...
        :style="disabled ? '' : 'transition:  300ms ease-out,  300ms ease-out;'"
      ...
      <button
        v-if="type === 'password'"
        type="button"
        class="absolute right-4 border-2 flex items-center  hover:text-primary focus:outline-none"
        @click="toggleReveal"
        tabindex="-1"
      >
  ...
  computed: {
    ...
    inputClasses() {
      ...
      return [
        ...
        // Focus states
        'focus:border-black focus:border-opacity-100 focus:text-black',
        'active:border-black active:border-opacity-100 active:text-black',
    ...
    labelClasses() {
      ...
      return [
        ...
        this.isFocused ? 'text-primary' : 'text-black',
